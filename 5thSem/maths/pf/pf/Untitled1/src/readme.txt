 	...
 	B. Set the path by doing one of the following:
		...
		* Add the MCR directory to the environment variable by issuing 
         ...
         NOTE: When deploying C and C++ standalone applications, it is possible
               to run the shell script file run_Untitled1.sh on UNIX and Mac
...
3. Collect the following files, based on what you are deploying: 
	...
	All Platforms:
		* Untitled1.ctf (Component Technology File archive,
		  platform-dependent on target machine)
			
        Windows:
		* MCRInstaller.exe (self-extracting MATLAB Component Runtime
		  library installer)   
		* Untitled1.exe (application created by MATLAB Compiler)
        UNIX:
		* MCRInstaller.bin (MATLAB Component Runtime library 
	 	  installer)
		* Untitled1 (application created by MATLAB Compiler)
		* run_Untitled1.sh (shell script that can be run 
	...
	All Platforms:            
		* Untitled1.dll (shared library, file extension 
		  varies by platform)
		* Untitled1.h (library header file)
		* Untitled1.ctf (Component Technology File archive,
	...
	* Untitled1.xml (documentation files)
	* Untitled1.pdb (program database file - if 
	  DEBUG option selected)
	* Untitled1.dll (component assembly file)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  
	...
	* Untitled1.ctf (Component Technology File archive, 
	  contains compiled M-code)
	* Untitled1_1_0.dll (COM component)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  	
	...
	* Untitled1.jar (Java class files and compiled M-code)
	...
	* Untitled1.ctf (Component Technology File archive, 
	  contains compiled M-code)
	* Untitled1.xla (Optionally created and placed in
	  E:\DMS -LAB NOTES\probabilty Robotics\pf\pf\Untitled1\src directory by the user)  
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  	
